...
@Component({
  ...
  templateUrl: './link-fields-form.component.html',
  styleUrls: ['./link-fields-form.component.scss'],
  standalone: true,
  ...
  providers: [
    {
      ...
      multi: true,
      useExisting: LinkFieldsFormComponent,
    },
    {
...
export class LinkFieldsFormComponent implements ControlValueAccessor, Validator, OnDestroy, OnInit {
